...
type
  AVCodecID* {.size: sizeof(cint).} = enum
    ...
    AV_CODEC_ID_AVS3, AV_CODEC_ID_MSP2, AV_CODEC_ID_VVC, AV_CODEC_ID_Y41P,
    AV_CODEC_ID_AVRP, AV_CODEC_ID_012V, AV_CODEC_ID_AVUI, AV_CODEC_ID_TARGA_Y216,
    ...
    AV_CODEC_ID_VBN, AV_CODEC_ID_JPEGXL, AV_CODEC_ID_QOI, AV_CODEC_ID_PHM,
    AV_CODEC_ID_RADIANCE_HDR, AV_CODEC_ID_WBMP, AV_CODEC_ID_MEDIA100,
    AV_CODEC_ID_VQC, AV_CODEC_ID_PDV, AV_CODEC_ID_EVC, AV_CODEC_ID_RTV1,
    AV_CODEC_ID_VMIX, AV_CODEC_ID_FIRST_AUDIO = 0x10000, AV_CODEC_ID_PCM_S16BE,
    ...
    AV_CODEC_ID_ADPCM_IMA_QT = 0x11000, AV_CODEC_ID_ADPCM_IMA_WAV,
    ...
    AV_CODEC_ID_ADPCM_AFC, AV_CODEC_ID_ADPCM_IMA_OKI, AV_CODEC_ID_ADPCM_DTK,
    AV_CODEC_ID_ADPCM_IMA_RAD, AV_CODEC_ID_ADPCM_G726LE, AV_CODEC_ID_ADPCM_THP_LE,
    AV_CODEC_ID_ADPCM_PSX, AV_CODEC_ID_ADPCM_AICA, AV_CODEC_ID_ADPCM_IMA_DAT4,
    AV_CODEC_ID_ADPCM_MTAF, AV_CODEC_ID_ADPCM_AGM, AV_CODEC_ID_ADPCM_ARGO,
    AV_CODEC_ID_ADPCM_IMA_SSI, AV_CODEC_ID_ADPCM_ZORK, AV_CODEC_ID_ADPCM_IMA_APM,
    AV_CODEC_ID_ADPCM_IMA_ALP, AV_CODEC_ID_ADPCM_IMA_MTF,
    AV_CODEC_ID_ADPCM_IMA_CUNNING, AV_CODEC_ID_ADPCM_IMA_MOFLEX,
    AV_CODEC_ID_ADPCM_IMA_ACORN, AV_CODEC_ID_ADPCM_XMD,
    AV_CODEC_ID_AMR_NB = 0x12000, AV_CODEC_ID_AMR_WB, AV_CODEC_ID_RA_144 = 0x13000,
    AV_CODEC_ID_RA_288, AV_CODEC_ID_ROQ_DPCM = 0x14000, AV_CODEC_ID_INTERPLAY_DPCM,
    AV_CODEC_ID_XAN_DPCM, AV_CODEC_ID_SOL_DPCM, AV_CODEC_ID_SDX2_DPCM,
    AV_CODEC_ID_GREMLIN_DPCM, AV_CODEC_ID_DERF_DPCM, AV_CODEC_ID_WADY_DPCM,
    AV_CODEC_ID_CBD2_DPCM, AV_CODEC_ID_MP2 = 0x15000, AV_CODEC_ID_MP3,
    ...
    AV_CODEC_ID_HCA, AV_CODEC_ID_FASTAUDIO, AV_CODEC_ID_MSNSIREN,
    AV_CODEC_ID_DFPWM, AV_CODEC_ID_BONK, AV_CODEC_ID_MISC4, AV_CODEC_ID_APAC,
    AV_CODEC_ID_FTR, AV_CODEC_ID_WAVARC, AV_CODEC_ID_RKA, AV_CODEC_ID_AC4,
    AV_CODEC_ID_OSQ, AV_CODEC_ID_FIRST_SUBTITLE = 0x17000, AV_CODEC_ID_DVB_SUBTITLE,
    ...
    AV_CODEC_ID_MICRODVD, AV_CODEC_ID_EIA_608, AV_CODEC_ID_JACOSUB,
    ...
    AV_CODEC_ID_ARIB_CAPTION, AV_CODEC_ID_FIRST_UNKNOWN = 0x18000,
    ...
    AV_CODEC_ID_TIMED_ID3, AV_CODEC_ID_BIN_DATA, AV_CODEC_ID_SMPTE_2038,
    AV_CODEC_ID_PROBE = 0x19000, AV_CODEC_ID_MPEG2TS = 0x20000,
    AV_CODEC_ID_MPEG4SYSTEMS = 0x20001, AV_CODEC_ID_FFMETADATA = 0x21000,
...
#     importc: "avcodec_get_type", header: "codec_id.h".}

proc avcodec_get_name*(id: AVCodecID): cstring {.importc: "avcodec_get_name",
    header: "codec_id.h".}

proc av_get_bits_per_sample*(codec_id: AVCodecID): cint {.
    importc: "av_get_bits_per_sample", header: "codec_id.h".}

proc av_get_exact_bits_per_sample*(codec_id: AVCodecID): cint {.
    importc: "av_get_exact_bits_per_sample", header: "codec_id.h".}

proc avcodec_profile_name*(codec_id: AVCodecID; profile: cint): cstring {.
    importc: "avcodec_profile_name", header: "codec_id.h".}

# proc av_get_pcm_codec*(fmt: AVSampleFormat; be: cint): AVCodecID {.
#     importc: "av_get_pcm_codec", header: "codec_id.h".}
