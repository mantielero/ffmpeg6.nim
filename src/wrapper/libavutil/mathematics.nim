...
when not declared(compilerbuiltinconstantp):
  ...
  static :
    hint("Declaration of " & "compilerbuiltinconstantp" &
        " already exists, not redeclaring")
type
  structavrational_520095668 {.pure, inheritable, bycopy.} = object
    num*: cint               ## Generated based on /home/jose/src/nimlang/ffmpeg.nim/src/wrapper/FFmpeg/libavutil/rational.h:58:16
    den*: cint

  Avrational_520095670 = structavrational_520095669 ## Generated based on /home/jose/src/nimlang/ffmpeg.nim/src/wrapper/FFmpeg/libavutil/rational.h:61:3
  unionavintfloat32_520095672 {.union, bycopy.} = object
    i*: uint32               ## Generated based on /home/jose/src/nimlang/ffmpeg.nim/src/wrapper/FFmpeg/libavutil/intfloat.h:27:7
    f*: cfloat

  unionavintfloat64_520095674 {.union, bycopy.} = object
    i*: uint64               ## Generated based on /home/jose/src/nimlang/ffmpeg.nim/src/wrapper/FFmpeg/libavutil/intfloat.h:32:7
    f*: cdouble

  unionavintfloat64_520095675 = (when declared(unionavintfloat64):
    unionavintfloat64
   else:
    unionavintfloat64_520095674)
  enumavrounding_520095677 = (when declared(enumavrounding):
    enumavrounding
   else:
    enumavrounding_520095676)
  structavrational_520095669 = (when declared(structavrational):
    structavrational
   else:
    structavrational_520095668)
  unionavintfloat32_520095673 = (when declared(unionavintfloat32):
    unionavintfloat32
   else:
    unionavintfloat32_520095672)
  Avrational_520095671 = (when declared(Avrational):
    Avrational
   else:
    Avrational_520095670)
when not declared(unionavintfloat64):
  type
    unionavintfloat64* = unionavintfloat64_520095674
else:
  static :
...
when not declared(structavrational):
  type
    structavrational* = structavrational_520095668
else:
  static :
...
when not declared(unionavintfloat32):
  type
    unionavintfloat32* = unionavintfloat32_520095672
else:
  static :
...
when not declared(Avrational):
  type
    Avrational* = Avrational_520095670
else:
  static :
...
when not declared(avq2intfloat):
  proc avq2intfloat*(q: Avrational_520095671): uint32 {.cdecl,
      importc: "av_q2intfloat".}
else:
  static :
    hint("Declaration of " & "avq2intfloat" & " already exists, not redeclaring")
when not declared(avgcdq):
  proc avgcdq*(a: Avrational_520095671; b: Avrational_520095671; maxden: cint;
               def: Avrational_520095671): Avrational_520095671 {.cdecl,
      importc: "av_gcd_q".}
else:
  static :
...
when not declared(avrescalernd):
  proc avrescalernd*(a: int64; b: int64; c: int64; rnd: enumavrounding_520095677): int64 {.
      cdecl, importc: "av_rescale_rnd".}
else:
  static :
    hint("Declaration of " & "avrescalernd" & " already exists, not redeclaring")
when not declared(avrescaleq):
  proc avrescaleq*(a: int64; bq: Avrational_520095671; cq: Avrational_520095671): int64 {.
      cdecl, importc: "av_rescale_q".}
else:
  static :
    hint("Declaration of " & "avrescaleq" & " already exists, not redeclaring")
when not declared(avrescaleqrnd):
  proc avrescaleqrnd*(a: int64; bq: Avrational_520095671; cq: Avrational_520095671;
                      rnd: enumavrounding_520095677): int64 {.cdecl,
...
when not declared(avcomparets):
  proc avcomparets*(tsa: int64; tba: Avrational_520095671; tsb: int64;
                    tbb: Avrational_520095671): cint {.cdecl,
...
when not declared(avrescaledelta):
  proc avrescaledelta*(intb: Avrational_520095671; ints: int64;
                       fstb: Avrational_520095671; duration: cint;
                       last: ptr int64; outtb: Avrational_520095671): int64 {.
...
when not declared(avaddstable):
  proc avaddstable*(tstb: Avrational_520095671; ts: int64; inctb: Avrational_520095671;
