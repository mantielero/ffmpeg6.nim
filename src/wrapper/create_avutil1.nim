...
importc:
  outputPath currentSourcePath.parentDir / "libavutil" / "rational.nim"
  path "./FFmpeg/libavutil"
  "libavutil/rational.h"

importc:
  outputPath currentSourcePath.parentDir / "libavutil" / "opt.nim"
  path "./FFmpeg/libavutil"
  "opt.h"
...
importc:
  outputPath currentSourcePath.parentDir / "libavutil" / "pixfmt.nim"
  path "./FFmpeg/libavutil"
  "pixfmt.h"
